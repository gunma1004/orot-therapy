...
def generate_seo_meta(region_name):
    """
    20가지 마사지 키워드 조합 템플릿 ('출장 [키워드] 마사지' 구조 통일)
    """
    templates = [
        # 1. 1:1 방문 홈케어
        {
            ...
            "h2": f"{region_name} 1:1 프라이빗 방문 홈케어 및 바디 마사지 프로그램",
        ...
        # 2. 100% 건전 힐링
        {
            ...
            "desc": f"{region_name} 출장 100% 건전 힐링 타이 마사지 추천. {SITE_NAME}의 품격 있는 바디 릴렉싱 마사지를 안심하고 예약하세요.",
            "h1": f"{region_name} 출장 <span>건전 힐링 마사지</span>",
            "h2": f"믿을 수 있는 {region_name} 100% 건전 테라피 & 안심 바디 마사지 코스",
        ...
        # 3. 상체 림프 순환 케어
        {
            ...
            "h2": f"{region_name} 상체 림프 순환 및 가슴 바디 릴렉싱 스페셜 마사지",
        ...
        # 4. 프리미엄 아로마 오일
        {
            ...
            "h2": f"천연 에센셜 오일 기반 {region_name} 프리미엄 아로마 바디 마사지",
        ...
        # 5. 프라이빗 스웨디시 감성
        {
            ...
            "h2": f"지친 일상을 녹여주는 {region_name} 프라이빗 스웨디시 감성 마사지",
        ...
        # 6. 상체 가슴 바디 릴렉싱
        {
            ...
            "h2": f"{region_name} 상체 가슴 순환 및 전신 릴렉스 마사지 프로그램",
        ...
        # 7. 안심 건전 힐링 케어
        {
            ...
            "h1": f"{region_name} 출장 <span>안심 건전 힐링 마사지</span>",
            "h2": f"남녀노소 편안하게 이용하는 {region_name} 안심 건전 힐링 마사지",
        ...
        # 8. 정통 홈타이 테라피
        {
            ...
            "h2": f"전신 근육 이완과 스트레칭을 돕는 {region_name} 정통 홈타이 마사지",
        ...
        # 9. 맞춤 림프 드레나쥐
        {
            ...
            "h2": f"몸의 순환을 돕는 {region_name} 맞춤형 림프 드레나쥐 마사지 코스",
        ...
        # 10. 24시 야간 홈케어
        {
            ...
            "h2": f"심야 및 24시간 언제나 신속하게 찾아가는 {region_name} 야간 홈케어 마사지",
        ...
        # 11. 가슴 림프 웰니스
        {
            ...
            "h2": f"{region_name} 가슴 림프 웰니스 및 상체 바디 마사지",
        ...
        # 12. VIP 프리미엄 방문 테라피
        {
            ...
            "h2": f"차별화된 고품격 힐링을 선사하는 {region_name} VIP 전용 방문 마사지",
        ...
        # 13. 전신 피로회복 딥티슈
        {
            ...
            "h2": f"만성 피로와 뭉친 근육을 깊숙이 풀어주는 {region_name} 딥티슈 마사지",
        ...
        # 14. 힐링 에스테틱 홈스파
        {
            ...
            "h2": f"집에서 누리는 프라이빗 스파 테라피, {region_name} 홈스파 힐링 마사지",
        ...
        # 15. 상체 집중 릴렉스
        {
            ...
            "h2": f"목, 어깨, 상체 가슴 중심의 {region_name} 집중 릴렉싱 바디 마사지",
        ...
        # 16. 건전 힐링 아로마
        {
            ...
            "h2": f"천연 에센스 오일로 피부와 심신을 안정시키는 {region_name} 건전 아로마 마사지",
        ...
        # 17. 1:1 방문 맞춤 컨디셔닝
        {
            ...
            "h2": f"개인별 체형과 컨디션을 고려한 {region_name} 1:1 맞춤형 바디 마사지",
        ...
        # 18. 소프트 감성 스웨디시
        {
            ...
            "h2": f"부드럽고 감미로운 터칭으로 긴장을 완화하는 {region_name} 소프트 스웨디시 마사지",
        ...
        # 19. 바디 밸런스 림프
        {
            ...
            "h2": f"흐트러진 신체 밸런스를 바로잡는 {region_name} 림프 순환 바디 마사지",
...
def update_html_content(content, region_name, meta):
    ...
    content = re.sub(
        r'<img([^>]*?)alt=["\'](.*?)["\']([^>]*?)>',
        lambda m: f'<img{m.group(1)}alt="{region_name} 프라이빗 힐링 바디 마사지"{m.group(3)}>'
...
def update_all_html_files():
    ...
    print(f"\n🎉 총 {updated_count}개 서브 페이지의 전체 SEO 태그 및 본문 교체가 완료되었습니다!")
