...
REGIONS = {
    ...
    "yangju": {"name": "경기 양주시", "dongs": ["회천동", "고읍동", "덕정동", "백석읍", "장흥면", "남면"]},
    "pocheon": {"name": "경기 포천시", "dongs": ["소흘읍", "선단동", "포천동", "군내면", "가산면", "창수면"]},
    "yeoju": {"name": "경기 여주시", "dongs": ["여흥동", "중앙동", "오학동", "가남읍", "점동면"]},
    ...
    "seohae": {"name": "인천 서해구", "dongs": ["연안동", "항동", "북성동"]},
    "geomdan": {"name": "인천 검단구", "dongs": ["마전동", "당하동", "원당동", "불로동", "오류동", "왕길동"]},
    "ganghwa": {"name": "인천 강화군", "dongs": ["강화읍", "선원면", "불은면", "길상면", "화도면", "양도면"]},
    "ongjin": {"name": "인천 옹진군", "dongs": ["백령면", "대청면", "덕적면", "자월면", "영흥면", "북도면"]}
}
...
def generate_all():
    ...
    print(f"\n🎉 [전체 완료] 루트 클린 메인 1개 + {gu_count}개 시·구 페이지 + {dong_count}개 세부 동 페이지 생성이 완료되었습니다!")
